	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: 'Orderannya Kak..',
                            orderTitle: 'MENU',
                            thumbnail: await (await fetch('https://telegra.ph/file/d56e1cad3c659075d08ee.jpg').buffer(),
                            sellerJid: '447710173736@s.whatsapp.net'
...
await conn.send3ButtonImg(m.chat, await (await fetch('https://telegra.ph/file/328f69bd3fa43a1aecb20.jpg')).buffer(),  'ʜᴇʀᴇ ᴍʏ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ', text, 'ʙᴀᴄᴋ', '.menu', 'ɪɴꜰᴏ', '.info', 'ᴀʟʟᴍᴇɴᴜ', '.pay', m, {  
      ...
      contextInfo: { //forwardingScore: 99999, isForwarded: true,  
          externalAdReply: {  showAdAttribution: true, 
              title: 'Nothoing',  
              body: 'Bentar Lagi Tahun Baru', 
              description: 'Tobat bg..', 
              mediaType: 2,  
            thumbnail: await (await fetch('https://telegra.ph/file/60a1edbcff2a7bfa46957.jpg')).buffer(), 
